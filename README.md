...
## 대학생의 경우 휴학만 편입을 신청할 수 있다. (재학중에도 가능한 방법이 있다 해당항목 맨 아래 확인) 
...
- 본인이 재학 중에 편입을 해야한다면 병무청이랑 얘기를 해서 편입을 한 후 **편입 한 당일** 복무확인서를 가지고 학교에 군 휴학을 신청한 후 휴학처리가 되야 한다. 그 후 휴학증명서를 다시 병무청에 제출하면 편입이 가능하다. 이 모든 과정이 **편입 한 당일** 날 모두 이루어져야 하므로 병무청에 미리 말을 해두어야하고 학교에다가는 군 휴학 신청을 넣으면 당일날 휴학 처리가 가능한지 꼭 물어봐야한다.
